...
public class TestSubset_OneOverlap {
	...
	public TestSubset_OneOverlap(int inputVar1, String inputVar2) {
		this(inputVar1, inputVar2, 0.0, 0.0);
	}

	public TestSubset_OneOverlap(int inputVar1, String inputVar2, double inputVar3, double inputVar4) {
