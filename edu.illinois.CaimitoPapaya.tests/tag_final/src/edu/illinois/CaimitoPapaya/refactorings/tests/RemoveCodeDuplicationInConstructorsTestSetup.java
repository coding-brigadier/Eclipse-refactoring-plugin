...
public class RemoveCodeDuplicationInConstructorsTestSetup extends RefactoringTestSetup {
	...
	public RemoveCodeDuplicationInConstructorsTestSetup(Test test) {
		super(test);
	}	
	...
	/**
	 * Gets the package representation of the "object_in" folder
	 * @return private variable fObjectTypes
	 */
